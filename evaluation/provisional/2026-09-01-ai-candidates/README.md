...
CSV, JSON ve provisional evaluation set verileri değiştirilmeden korunmuştur;
Markdown raporun yalnızca metodolojik tanımı 2 Eylül 2026 tarihinde kullanıcı
izniyle düzeltilmiştir. Kayıtlar kullanıcı tarafından tek tek incelenip
onaylanmamıştır.
...
`retrieval_benchmark.original.md` içindeki yanlış “insan onaylı gold set” ifadesi
kaldırılmış; rapor AI-generated candidate set üzerindeki provisional teknik koşu
olarak etiketlenmiştir. Metrik tabloları ve ölçüm değerleri değiştirilmemiştir.
